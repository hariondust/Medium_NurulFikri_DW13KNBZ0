...
export default class CategoryMain extends Component {
  render() {
    ...
    return (
          ...
          <Grid relaxed>
                  <Grid.Row column={2} style={{maxWidth:"1192px", marginLeft:"150px"}}>
                    <Grid.Column width={10} style={{height:"354px", marginTop:"20px", padding:"0px"}}>
                      <div className="articlePicture">
                          <Image src={this.props.img1} height="354px" width="748"></Image>
                      </div>
                    </Grid.Column>
                ...
                <Grid.Row column={2} style={{maxWidth:"1192px", marginLeft:"150px"}}>
                  ...
                  <Grid.Column width={10} style={{height:"354px", marginTop:"20px", padding:"0px"}}>
                      <div className="articlePicture">
                          <Image src={this.props.img2} height="354px" width="748"></Image>
                      </div>
                  </Grid.Column>
                </Grid.Row>
            </Grid>
